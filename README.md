...
As before, the numbered steps show how it's done.
...
This tutorial is similar the Tutorial 1, but this time we'll serialise a map
of strings rather than a vector of strings.
