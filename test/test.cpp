...
/*  In this tutorial we'll turn a std::vector of std::strings into Loon text.

    Given a vector of strings, the Loon text generated by our serialise()
...
/*  In this tutorial we'll write a function that takes Loon text like this
    ...
    and returns a vector of the strings.
*/
